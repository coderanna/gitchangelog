...
var gitPublicUrl = require("git-public-url");
...
var formatOptions = [
	...
	"commiturl", "title:%s", "%w(80,1,1)%b"
].join("%n");

function getUrl (commits) {
	var commiturl;
	commits.forEach(function(commit){
		//commiturl = gitPublicUrl(commit);
		commiturl = "http://www.google.com";
		return commiturl;
		//https://gitlab.kroger.com/products/kroger-product-grid-bff/blob/master/src/test/java/com/kroger/product/nutrition/NutritionDataMapperTest.java
	});
}
